...
class VibhagExport implements FromCollection , WithHeadings
{
...
// dd($list);
    ...
    public function headings():array
    {
        return [
            ...
            'Career', 'Career Sub', 'Year of Birth', 'Javabdari', 'Vasathi', 'Upavasathi', 'Nagar', 'Bhag', 'Vibhag', 'Created_at'];
        } 
    }
