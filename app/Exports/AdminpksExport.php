...
class AdminpksExport implements FromCollection , WithHeadings
{
...
//  }
    ...
    public function collection()
    {
        ...
        // ->select('pks_form.id','pks_form.name','pks_form.phone', 'pwa_responsibilitypks.name as javb', 'pwa_karyavibhag.name as career', 'jm_blr_rs_vasathi.name as vname', 'jm_blr_rs_nagar.name as nname', 'jm_blr_rs_bhag.name as bname', 'jm_blr_rs_vibhag.name as vibname', 
