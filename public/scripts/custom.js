...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaName = "RSSKDP"; //Local Storage Names for PWA
    ...
    var pwaScope = "/";
    var url = '';
    var pwaLocation = "./public/_service-worker.js";
    ...
    function init_template(){
        ...
        if(pageTitle){
            ...
            var greetingUser = document.querySelectorAll('.greeting-text')[0].getAttribute('data-username');
                ...
                document.querySelectorAll('.greeting-text')[0].insertAdjacentHTML('beforeend', greetingMessage + '&nbsp;' +greetingUser);
            }
        }
        ...
        function highlightColors(){
            ...
            if(rememberHighlight){
                ...
                loadHighlight.className = "page-highlight";
                loadHighlight.type = "text/css";
                loadHighlight.href = 'public/styles/highlights/highlight_' + rememberHighlight +'.css';
