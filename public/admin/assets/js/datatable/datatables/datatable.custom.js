$(document).ready(function() {
    ...
    $('#advance-8').DataTable({
        "language": {
            "url": "../public/admin/assets/json/German.json"
        }
    });
    $('#advance-9').DataTable({
        "searching": false,
    ...
    $('#data-source-2').DataTable({
        "ajax": '../public/admin/assets/ajax/arrays.txt'
    });
    var dataSet = [
    ...
    $('#data-source-4').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "../public/admin/assets/json/server-side.json"
    } );
    ...
    var ct = $('#API-chield-row').DataTable({
        "ajax": "../public/admin/assets/ajax/api.txt",
        "columns": [{
    ...
    $('#ajax-data-object').DataTable({
        "ajax": "../public/admin/assets/ajax/object.txt",
        "columns": [{
            "data": "name"
        }, {
            "data": "position"
    ...
    $('#ajax-data-nested-object').DataTable({
        "processing": true,
        "ajax": "../public/admin/assets/ajax/object_nested.txt",
        "columns": [{
            "data": "name"
            }, {
                "data": "hr.position"
    ...
    $('#orthogonal-data').DataTable({
        ajax: "../public/admin/assets/ajax/orthogonal.txt",
        columns: [{
            data: "name"
        }, {
            data: "position"
    ...
    $('#server-side-datatable').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "../public/admin/assets/ajax/server-processing.php"
    });
    ...
    $('#datatable-http').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "../public/admin/assets/ajax/server-processing.php",
            data: function(d) {
                d.myKey = "myValue";
            }
        },  
    ...
    $('#datatable-post').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "../public/admin/assets/ajax/post.php",
            type: "post"
        },
        "columns": [{
            "data": "first_name"
