    ...
    <div class="page-content">
        ...
        <div class="card card-style">
            <div class="card-body">
             ...
             <h2 class="mb-4">Bhag / Jille Dashboard</h2>
             <h5 class="color-highlight">{{$reports['bhag']->name}}</h5>
        ...
        <!--    </div>-->
         ...
         <div class="card card-style">
			<div class="content">
				<h2 class="color-highlight m-4 text-uppercase">{{$vib->name}}</h2>
			<?php
				$id = $vib->id;
				 $reports['mandala'] = DB::table('jm_blr_rs_vasathi')->where('nagar_id',$id)->get();
				
				foreach($reports['mandala'] as $mad)
				{
				?>
				 <div class="d-flex">
					<div class="ps-3">
