  ...
  <div class="container-fluid">    
    <div class="page-title">
      <div class="row">
        ...
        <div class="col-12 col-sm-6">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"> <a class="home-item" href="{{route('vibhag.admindashboard')}}"><i data-feather="home"></i></a></li>
          ...
          <div class="card-header pb-0">
            <div class="media">
              <div class="">
                  ...
                  @endphp
                <h5 class="text-capitalize">{{$name}} Vibhag - Swayamsevak Registration</h5>
              </div>
            </div>
          </div>
          <div class="card-body">
          ...
          <div class="card">
            <div class="card-header">
              <div class="text-end mt-2" >
                  @php
                  $vid =  Session::get('admin')->vid;
                  @endphp
                <a role="button" class="btn btn-primary" href="{{route('vibhag.report.vibhag.export.id', ['id'=>$vid])}}">Excel</a>
              </div>
            </div>
            <div class="card-body">
