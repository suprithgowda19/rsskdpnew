@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        ...
        <!--            {{-- Previous Page Link --}}-->
        <!--            @if ($paginator->onFirstPage())-->
        <!--                <a aria-disabled="true" aria-label="{{ __('pagination.previous') }}">-->
        <!--                    <a class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default rounded-l-md leading-5" aria-hidden="true">-->
        <!--                        &lsaquo;-->
        <!--                    </a>-->
        <!--                </a>-->
        <!--            @else-->
        ...
        <!--                    <a class="relative inline-flex items-center px-2 py-2 -ml-px text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default rounded-r-md leading-5" aria-hidden="true">-->
        <!--                        Nex-->
        <!--                    </a>-->
        <!--                </a>-->
        <!--            @endif-->
