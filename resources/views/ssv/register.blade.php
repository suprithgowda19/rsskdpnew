...
<div class="card card-style">
    <div class="content mb-0 mt-3">
       <h3 class="text-center py-3 mt-3">{{ __('messages.regform123') }}</h3>
        <h3 class="text-center py-3">{{ __('messages.regform122') }}</h3>
  ...
  <!-- FORM START -->
        ...
        <form method="post" action="{{route('ssv.register.api')}}" >
           ...
           <div class="col-md-12 input-style-always-active has-borders no-icon mb-4" style="position: relative;margin-bottom: 15px !important;">
            <label for="prof" class="color-highlight profess-tag">{{ __('messages.regselect') }} {{ __('messages.ssvregfield1') }} (Required)</label>
            <select required class="form-select varga profess-tag-1" name="vargaid" data-placeholder="{{ __('messages.regselect') }}" style="border-color: rgba(0, 0, 0, 0.08) !important;">
        ...
        <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4">
            ...
            <div class="firstdiv">
             <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4">
                <input type="text" class="form-control validate-text "  placeholder="{{ __('messages.ssvregfield4') }}" name="fprath"  >
                <label for="date2" class="color-highlight">{{ __('messages.ssvregfield4') }} (Optional)</label>
            </div>
            <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4">
                <input type="text" class="form-control validate-text "  placeholder="{{ __('messages.ssvregfield41') }}" name="fprathyear"  >
                <label for="date2" class="color-highlight">{{ __('messages.ssvregfield41') }} (Optional)</label>
            </div>
            </div>
            <div class="seconddiv">
                <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4">
                <input type="text" class="form-control validate-text "  placeholder="{{ __('messages.ssvregfield5') }}" name="sprath"  >
                <label for="date2" class="color-highlight">{{ __('messages.ssvregfield5') }} </label>
            </div>
            <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4">
                <input type="text" class="form-control validate-text "  placeholder="{{ __('messages.ssvregfield51') }}" name="sprathyear"  >
                <label for="date2" class="color-highlight">{{ __('messages.ssvregfield51') }} </label>
            </div>
            </div>
            <div class="thirddiv">
                <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4">
                <input type="text" class="form-control validate-text "  placeholder="{{ __('messages.ssvregfield6') }}" name="tprath"  >
                <label for="date2" class="color-highlight">{{ __('messages.ssvregfield6') }} </label>
            </div>
            <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4">
                <input type="text" class="form-control validate-text "  placeholder="{{ __('messages.ssvregfield61') }}" name="tprathyear"  >
                <label for="date2" class="color-highlight">{{ __('messages.ssvregfield61') }} </label>
            </div>
            </div>
        ...
        <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4">
          ...
          <div class="row p-2 pl-4 mb-2">
              <div class="col-md-6 form-check icon-check">
                          <input class="form-check-input shakehead" type="radio" name="shakehead" value="1" id="radio1">
                          <label class="form-check-label" for="radio1">{{ __('messages.ssvregfield2') }}</label>
                          <i class="icon-check-1 fa fa-square color-gray-dark font-16"></i>
                          <i class="icon-check-2 fa fa-check-square font-16 color-highlight"></i>
                     </div>
                     <div class="col-md-6  form-check icon-check ">
                          <input class="form-check-input shakehead" type="radio" name="shakehead" value="2" id="radio2">
                          <label class="form-check-label" for="radio2">{{ __('messages.ssvregfield3') }}</label>
                          <i class="icon-check-1 fa fa-square color-gray-dark font-16"></i>
                          <i class="icon-check-2 fa fa-check-square font-16 color-highlight"></i>
                      </div>
              </div>
          <div class="shakediv input-style input-style-always-active has-borders no-icon validate-field mb-4">
              <input type="text" class="form-control validate-text shake " placeholder="{{ __('messages.regform1') }}"  name="shake" id="shake"  >
              <label for="shake" class="color-highlight">{{ __('messages.regform1') }} (Required)</label>
          </div>
          <div class="col-md-12  has-borders no-icon mb-4" style="position: relative;margin-bottom: 15px !important;">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('.shakediv').hide();
         $('body').on('change', '.shakehead', function () {
              $('.shakediv').show();
         });
        $('.firstdiv').hide();
        $('.seconddiv').hide();
        ...
        $.ajax({
            ...
            { 
                ...
                {
                    $(".varga").html('');
                    $(".varga").append("<option label='Please Select' value=''>Select any one</option>");
                    $.each(data, function(i, item)
                    {
                        $(".varga").append("<option value="+item.id+">"+item.name+" - "+item.name_ka+"</option>");      
                    });
        ...
        //list careers
        $.ajax({
            url: '{{route('registercategory.list.ssv')}}',
            type: 'GET',
            dataType: 'JSON',
            success: function (data) 
            { 
        ...
        //list javadari
        $.ajax({
            url: '{{route('registerresp.list.ssv')}}',
            type: 'GET',
            dataType: 'JSON',
            success: function (data) 
            { 
        ...
        $('.resp').on('change', function(){
            ...
            else if($(this).val() == 7)
            {
                ...
                $(".resposubsub").prop('required',false);
                 ...
                 $.ajax({
                    url: '{{route('registerrespsub.list.ssv')}}',
                    type: 'POST',
        ...
        $('.prof').on('change', function(){
                ...
                $.ajax({
                    url: '{{route('registersubcategory.list.ssv')}}',
                    type: 'POST',
