...
<div class="content mt-0">
    <div class="row">
        ...
        <div class="col-6">
            <a href="{{ route('ssv.checkstatus')}}" class="btn btn-full btn-border btn-m rounded-s text-uppercase font-900 shadow-l border-highlight color-highlight">{{ __('messages.indexbutton2') }}</a>
        </div>
    </div>
</div>
...
<!--            <a href="https://rsskdp.org/register" class="btn btn-full btn-m rounded-s text-uppercase font-900 shadow-xl bg-highlight">{{ __('messages.indexbutton1') }}</a>-->
<!--        </div>-->
<!--        <div class="pt-4 text-center">-->
<!--            <h3>{{ __('messages.indexbutton7') }}</h3>-->
<!--        </div>-->
<!--    </div>-->
<!--</div>-->
<!--<div class="content mt-0">-->
