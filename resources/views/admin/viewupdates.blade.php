              ...
              <div class="col-sm-12">
                <div class="blog-single">
                  <div class="blog-box blog-details">
                    <div class="card banner-wrraper"><img class="img-fluid w-100 bg-img-cover" src="{{asset('uploads/updates')}}/<?=$updates->image;?>" alt="blog-main"></div>
                    <div class="card">
                      <div class="card-body">
                        <div class="blog-details">
                          <ul class="blog-social">
                            <li><i class="fa fa-calendar-o"></i>{!! date('d M Y', strtotime($updates->updated_at)) !!}</li>
                            <li><i class="fa fa-tag"></i>{{$updates->tag}}</li>
                            <li><i class="fa fa-clock-o"></i><?=$updates->status== '1' ? "Activated" : "Not-Activated";?></li>
                          </ul>
                          <h4>
                            {{$updates->title}}
                          </h4>
