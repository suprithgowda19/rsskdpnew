      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header pb-0">
            <h5>Add Basavanagudi updates</h5>
          </div>
          <div class="card-body add-post">
            <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.updates.store')}}" enctype='multipart/form-data'>
                @csrf
              <div class="col-sm-12">
                <div class="mb-3">
                  <label for="validationCustom01">Title</label>
                  <input class="form-control" id="validationCustom01" type="text" name="title" placeholder="Add Basavanagudi updates Title" required="">
                </div>
                <div class="mb-3">
                  <label for="validationCustom03">Tag name</label>
                  <input class="form-control" id="validationCustom03" type="text" name="tag" placeholder="please enter tag name" required="">
                </div>
                <div class="mb-3">
                  <label for="validationCustom02">About</label> <span>(Only 25 words)</span>
                  <input class="form-control" id="validationCustom02" type="text" name="about" placeholder="small description" required="">
                </div>
                <div class="mb-3">
