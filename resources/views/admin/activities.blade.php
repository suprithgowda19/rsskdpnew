      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body add-post">
            <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.activities.store')}}" enctype='multipart/form-data'>
                @csrf
              <div class="col-sm-12">
                <div class="mb-3">
                  <label for="validationCustom01">Title</label>
                  <input class="form-control" id="validationCustom01" type="text" name="title" placeholder="Add Resources Title" required="">
                </div>
                <div class="mb-3">
                ...
                <div class=" mb-3">
                  <label class="form-label" for="image2">Multiple Images</label>
                  <input type="file" class="form-control" id="image2" name="image2[]"   accept="" multiple required>
                </div>
                <div class="mb-3">
                  <div class="media">
