              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                      <h5>Basavanagudi updates</h5>
                    <div class="mb-3 text-end">
                        <a href="{{route('adminupdates.add')}}">
                        <button class="btn btn-square btn-primary" type="button" data-bs-original-title="" title="">Add Basavanagudi updates</button>
                        </a>
                    </div>
                   </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      <table class="display" id="updates" style="width:100%">
                        <thead>
                          <tr>
                           <th>#</th>
                            <th>Title</th>
		 ...
		 $(document).ready(function(){
				...
				$('body').on('click', '#show-delete', function () {
					var _id = $(this).data("id");
						$.ajax({
								type: "get",
								url: SITEURL + "/admin/updates/delete/"+_id,
								success: function (data) {
									
									var oTable = $('#updates').dataTable();
									oTable.fnDraw(false);
								},
								error: function (data) {
