      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body add-post">
            <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.scheme.store')}}" enctype='multipart/form-data'>
                @csrf
              <div class="col-sm-12">
                <div class="mb-3">
                  <label for="validationCustom01">Title</label>
                  <input class="form-control" id="validationCustom01" type="text" name="title" placeholder="Add Insight Title" required="">
                </div>
                <div class="mb-3">
                 <label for="validationCustom02">Count</label>
                  <input class="form-control" id="validationCustom02" type="number" name="count" placeholder="Add Insight count" required="">
                </div>
                <div class=" mb-3">
                  <label class="form-label" for="fileInput">Upload Image</label><span>(SVG format)</span>
                  <input type="file" class="form-control" id="fileInput" name="image"   accept=".svg"  required>
                </div>
                <div class="mb-3">
                  <div class="media">
